...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_7481 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_7481(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_7483 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_7483(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_7486 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_7486(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_7487 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_7487(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_7491 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_7491(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_7496 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_7496(reader);
}
});
...
var G__7541 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__7542 = s.append(c);
c = G__7541;
s = G__7542;
continue;
}
