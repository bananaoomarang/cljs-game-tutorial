...
var digit_8219 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_8220__$1 = (vlq >>> (5));
while(true){
if((vlq_8220__$1 > (0))){
var digit_8221__$1 = (digit_8219 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_8221__$1));

var G__8222 = (vlq_8220__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__8223 = (vlq_8220__$1 >>> (5));
digit_8219 = G__8222;
vlq_8220__$1 = G__8223;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_8219));
}
break;
}
...
var G__8226 = i__$1;
var G__8227 = result__$1;
var G__8228 = shift__$1;
i = G__8226;
result = G__8227;
shift = G__8228;
continue;
