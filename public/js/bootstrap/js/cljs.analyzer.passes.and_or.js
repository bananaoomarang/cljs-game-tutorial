...
cljs.analyzer.passes.and_or.simple_test_expr_QMARK_ = (function cljs$analyzer$passes$and_or$simple_test_expr_QMARK_(p__13286){
var map__13287 = p__13286;
var map__13287__$1 = cljs.core.__destructure_map(map__13287);
var ast = map__13287__$1;
var op = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13287__$1,new cljs.core.Keyword(null,"op","op",-1882987955));
return cljs.core.boolean$((function (){var and__5000__auto__ = cljs.analyzer.passes.and_or.simple_op_QMARK_(ast);
if(and__5000__auto__){
var G__13290 = (function (){var or__5002__auto__ = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(ast);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
if(cljs.core.truth_((function (){var fexpr__13291 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"var","var",-769682797),null,new cljs.core.Keyword(null,"local","local",-1497766724),null], null), null);
return (fexpr__13291.cljs$core$IFn$_invoke$arity$1 ? fexpr__13291.cljs$core$IFn$_invoke$arity$1(op) : fexpr__13291.call(null,op));
})())){
...
var fexpr__13289 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol(null,"seq","seq",-177272256,null),"null",new cljs.core.Symbol(null,"boolean","boolean",-278886877,null),"null"], null), null);
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__13305_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(local,new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(p1__13305_SHARP_));
}),xs);
}));
}),loop_lets);
}));
...
var G__13311 = cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(ast,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"env","env",-1815813235),new cljs.core.Keyword(null,"locals","locals",535295783)], null),cljs.core.dissoc,local);
...
return cljs.analyzer.passes.and_or.remove_loop_let(G__13311,local);
} else {
return G__13311;
}
});
...
var map__13312 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__13312__$1 = cljs.core.__destructure_map(map__13312);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13312__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13312__$1,new cljs.core.Keyword(null,"name","name",1843675177));
...
var map__13317 = cljs.core.first(new cljs.core.Keyword(null,"bindings","bindings",1271397192).cljs$core$IFn$_invoke$arity$1(ast));
var map__13317__$1 = cljs.core.__destructure_map(map__13317);
var init = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13317__$1,new cljs.core.Keyword(null,"init","init",-1875481434));
var name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13317__$1,new cljs.core.Keyword(null,"name","name",1843675177));
