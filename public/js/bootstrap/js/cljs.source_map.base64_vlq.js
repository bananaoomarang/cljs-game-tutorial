...
var digit_14467 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_14468__$1 = (vlq >>> (5));
while(true){
if((vlq_14468__$1 > (0))){
var digit_14469__$1 = (digit_14467 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_14469__$1));

var G__14470 = (vlq_14468__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__14471 = (vlq_14468__$1 >>> (5));
digit_14467 = G__14470;
vlq_14468__$1 = G__14471;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_14467));
}
break;
}
...
var G__14472 = i__$1;
var G__14473 = result__$1;
var G__14474 = shift__$1;
i = G__14472;
result = G__14473;
shift = G__14474;
continue;
