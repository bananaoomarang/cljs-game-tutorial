...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_13479 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_13479(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_13486 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_13486(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13487 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13487(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13491 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13491(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13495 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13495(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13498 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13498(reader);
}
});
...
var G__13572 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__13573 = s.append(c);
c = G__13572;
s = G__13573;
continue;
}
