  ...
  class CacheClass {
    ...
    set(key, value) {
      ...
      (key.forEach(key2 => {
        ...
        this._cache.has(key2) && this._cache.get(key2) !== value && console.warn("[Cache] already has key:", key2);
...
goog.global. module$node_modules$$pixi$assets$lib$cache$Cache=shadow.js.require("module$node_modules$$pixi$assets$lib$cache$Cache", {});
