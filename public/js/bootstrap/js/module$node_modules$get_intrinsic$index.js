shadow$provide.module$node_modules$get_intrinsic$index = function(global, require, module, exports) {
  global = require("module$node_modules$es_errors$index");
  exports = require("module$node_modules$es_errors$eval");
  var $RangeError = require("module$node_modules$es_errors$range"), $ReferenceError = require("module$node_modules$es_errors$ref"), $SyntaxError = require("module$node_modules$es_errors$syntax"), $TypeError = require("module$node_modules$es_errors$type"), $URIError = require("module$node_modules$es_errors$uri"), $Function = Function, getEvalledConstructor = function(expressionSyntax) {
    try {
  ...
  }() : throwTypeError, hasSymbols = require("module$node_modules$has_symbols$index")(), hasProto = require("module$node_modules$has_proto$index")(), getProto = Object.getPrototypeOf || (hasProto ? function(x) {
    return x.__proto__;
  } : null), needsEval = {};
  hasProto = "undefined" !== typeof Uint8Array && getProto ? getProto(Uint8Array) : void 0;
  var INTRINSICS = {__proto__:null, "%AggregateError%":"undefined" === typeof AggregateError ? void 0 : AggregateError, "%Array%":Array, "%ArrayBuffer%":"undefined" === typeof ArrayBuffer ? void 0 : ArrayBuffer, "%ArrayIteratorPrototype%":hasSymbols && getProto ? getProto([][Symbol.iterator]()) : void 0, "%AsyncFromSyncIteratorPrototype%":void 0, "%AsyncFunction%":needsEval, "%AsyncGenerator%":needsEval, "%AsyncGeneratorFunction%":needsEval, "%AsyncIteratorPrototype%":needsEval, "%Atomics%":"undefined" === 
  typeof Atomics ? void 0 : Atomics, "%BigInt%":"undefined" === typeof BigInt ? void 0 : BigInt, "%BigInt64Array%":"undefined" === typeof BigInt64Array ? void 0 : BigInt64Array, "%BigUint64Array%":"undefined" === typeof BigUint64Array ? void 0 : BigUint64Array, "%Boolean%":Boolean, "%DataView%":"undefined" === typeof DataView ? void 0 : DataView, "%Date%":Date, "%decodeURI%":decodeURI, "%decodeURIComponent%":decodeURIComponent, "%encodeURI%":encodeURI, "%encodeURIComponent%":encodeURIComponent, "%Error%":global, 
  "%eval%":eval, "%EvalError%":exports, "%Float32Array%":"undefined" === typeof Float32Array ? void 0 : Float32Array, "%Float64Array%":"undefined" === typeof Float64Array ? void 0 : Float64Array, "%FinalizationRegistry%":"undefined" === typeof FinalizationRegistry ? void 0 : FinalizationRegistry, "%Function%":$Function, "%GeneratorFunction%":needsEval, "%Int8Array%":"undefined" === typeof Int8Array ? void 0 : Int8Array, "%Int16Array%":"undefined" === typeof Int16Array ? void 0 : Int16Array, "%Int32Array%":"undefined" === 
  typeof Int32Array ? void 0 : Int32Array, "%isFinite%":isFinite, "%isNaN%":isNaN, "%IteratorPrototype%":hasSymbols && getProto ? getProto(getProto([][Symbol.iterator]())) : void 0, "%JSON%":"object" === typeof JSON ? JSON : void 0, "%Map%":"undefined" === typeof Map ? void 0 : Map, "%MapIteratorPrototype%":"undefined" !== typeof Map && hasSymbols && getProto ? getProto((new Map())[Symbol.iterator]()) : void 0, "%Math%":Math, "%Number%":Number, "%Object%":Object, "%parseFloat%":parseFloat, "%parseInt%":parseInt, 
  ...
  void 0 : SharedArrayBuffer, "%String%":String, "%StringIteratorPrototype%":hasSymbols && getProto ? getProto(""[Symbol.iterator]()) : void 0, "%Symbol%":hasSymbols ? Symbol : void 0, "%SyntaxError%":$SyntaxError, "%ThrowTypeError%":ThrowTypeError, "%TypedArray%":hasProto, "%TypeError%":$TypeError, "%Uint8Array%":"undefined" === typeof Uint8Array ? void 0 : Uint8Array, "%Uint8ClampedArray%":"undefined" === typeof Uint8ClampedArray ? void 0 : Uint8ClampedArray, "%Uint16Array%":"undefined" === typeof Uint16Array ? 
  void 0 : Uint16Array, "%Uint32Array%":"undefined" === typeof Uint32Array ? void 0 : Uint32Array, "%URIError%":$URIError, "%WeakMap%":"undefined" === typeof WeakMap ? void 0 : WeakMap, "%WeakRef%":"undefined" === typeof WeakRef ? void 0 : WeakRef, "%WeakSet%":"undefined" === typeof WeakSet ? void 0 : WeakSet};
  if (getProto) {
    try {
      null.error;
    } catch (e) {
      global = getProto(getProto(e)), INTRINSICS["%Error.prototype%"] = global;
    }
  }
  ...
  global = require("module$node_modules$function_bind$index");
  var hasOwn = require("module$node_modules$hasown$index"), $concat = global.call(Function.call, Array.prototype.concat), $spliceApply = global.call(Function.apply, Array.prototype.splice), $replace = global.call(Function.call, String.prototype.replace), $strSlice = global.call(Function.call, String.prototype.slice), $exec = global.call(Function.call, RegExp.prototype.exec), rePropName = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, reEscapeChar = 
  /\\(\\)?/g, stringToPath = function(string) {
...
goog.provide("module$node_modules$get_intrinsic$index");
goog.global. module$node_modules$get_intrinsic$index=shadow.js.require("module$node_modules$get_intrinsic$index", {});
