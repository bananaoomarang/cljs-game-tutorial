shadow$provide.module$node_modules$object_inspect$index = function(global, require, module, exports) {
  ...
  function wrapQuotes(s, defaultStyle, opts) {
    defaultStyle = "double" === (opts.quoteStyle || defaultStyle) ? '"' : "'";
    return defaultStyle + s + defaultStyle;
  }
  function isArray(obj) {
    return "[object Array]" === objectToString.call(obj) && (!toStringTag || !("object" === typeof obj && toStringTag in obj));
  }
  function isDate(obj) {
    return "[object Date]" === objectToString.call(obj) && (!toStringTag || !("object" === typeof obj && toStringTag in obj));
  }
  function isRegExp(obj) {
    return "[object RegExp]" === objectToString.call(obj) && (!toStringTag || !("object" === typeof obj && toStringTag in obj));
  }
  function isError(obj) {
    return "[object Error]" === objectToString.call(obj) && (!toStringTag || !("object" === typeof obj && toStringTag in obj));
  }
  function isString(obj) {
    return "[object String]" === objectToString.call(obj) && (!toStringTag || !("object" === typeof obj && toStringTag in obj));
  }
  function isNumber(obj) {
    return "[object Number]" === objectToString.call(obj) && (!toStringTag || !("object" === typeof obj && toStringTag in obj));
  }
  function isBoolean(obj) {
    return "[object Boolean]" === objectToString.call(obj) && (!toStringTag || !("object" === typeof obj && toStringTag in obj));
  }
  ...
  function inspectString(str, opts) {
    ...
    str = $replace.call($replace.call(str, /(['\\])/g, "\\$1"), /[\x00-\x1f]/g, lowbyte);
  ...
  var inspectSymbol = isSymbol(require) ? require : null;
  module.exports = function inspect_(obj, options, depth, seen) {
    ...
    var opts = options || {};
    if (hasOwn.call(opts, "quoteStyle") && "single" !== opts.quoteStyle && "double" !== opts.quoteStyle) {
    ...
    return i ? markBoxed(inspect(bigIntValueOf.call(obj))) : isBoolean(obj) ? markBoxed(booleanValueOf.call(obj)) : isString(obj) ? markBoxed(inspect(String(obj))) : "undefined" !== typeof window && obj === window ? "{ [object Window] }" : obj === global ? "{ [object globalThis] }" : isDate(obj) || isRegExp(obj) ? String(obj) : (str = arrObjKeys(obj, inspect), i = gPO ? gPO(obj) === Object.prototype : obj instanceof Object || obj.constructor === Object, customInspect = obj instanceof Object ? "" : 
    "null prototype", maxDepth = !i && toStringTag && Object(obj) === obj && toStringTag in obj ? $slice.call(objectToString.call(obj), 8, -1) : customInspect ? "Object" : "", i = (i || "function" !== typeof obj.constructor ? "" : obj.constructor.name ? obj.constructor.name + " " : "") + (maxDepth || customInspect ? "[" + $join.call($concat.call([], maxDepth || [], customInspect || []), ": ") + "] " : ""), 0 === str.length ? i + "{}" : options ? i + "{" + indentedJoin(str, options) + "}" : i + "{ " + 
    $join.call(str, ", ") + " }");
  };
...
goog.provide("module$node_modules$object_inspect$index");
goog.global. module$node_modules$object_inspect$index=shadow.js.require("module$node_modules$object_inspect$index", {});
