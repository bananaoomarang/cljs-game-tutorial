...
var i_13554 = (self__.level + (1));
while(true){
if((i_13554 <= (new_level + (1)))){
(update[i_13554] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_13556 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_13556[i]));
} else {
x__$2.forward.push((((i < links_13556.length))?(links_13556[i]):null));
}

if((i < links_13556.length)){
(links_13556[i] = x__$2);
} else {
links_13556.push(x__$2);
}
...
var links_13563 = (update[i_13562]).forward;
if((x__$1 === (((i_13562 < links_13563.length))?(links_13563[i_13562]):null))){
...
var G__13571 = nx;
var G__13572 = (level__$1 - (1));
x = G__13571;
level__$1 = G__13572;
continue;
} else {
var G__13573 = x;
var G__13574 = (level__$1 - (1));
x = G__13573;
level__$1 = G__13574;
continue;
}
