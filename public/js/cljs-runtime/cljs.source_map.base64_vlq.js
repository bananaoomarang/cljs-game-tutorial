...
var digit_11639 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_11640__$1 = (vlq >>> (5));
while(true){
if((vlq_11640__$1 > (0))){
var digit_11641__$1 = (digit_11639 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_11641__$1));

var G__11642 = (vlq_11640__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__11643 = (vlq_11640__$1 >>> (5));
digit_11639 = G__11642;
vlq_11640__$1 = G__11643;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_11639));
}
break;
}
...
var G__11648 = i__$1;
var G__11649 = result__$1;
var G__11650 = shift__$1;
i = G__11648;
result = G__11649;
shift = G__11650;
continue;
