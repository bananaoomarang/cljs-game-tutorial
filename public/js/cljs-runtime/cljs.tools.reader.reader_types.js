...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_11612 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_11612(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_11613 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_11613(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11614 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_11614(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11615 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_11615(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11619 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_11619(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11620 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_11620(reader);
}
});
...
var G__11636 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__11637 = s.append(c);
c = G__11636;
s = G__11637;
continue;
}
