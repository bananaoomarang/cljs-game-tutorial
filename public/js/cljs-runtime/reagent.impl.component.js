...
var or__5002__auto__ = (function (){var G__11641 = c;
...
var G__11645 = c;
var G__11645__$1 = (((G__11645 == null))?null:G__11645.constructor);
if((G__11645__$1 == null)){
return null;
} else {
return G__11645__$1.name;
}
}
});
...
var c = this;
var G__11656_11743 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__11656_11743 == null)){
} else {
reagent.ratom.dispose_BANG_(G__11656_11743);
}
...
var renders_11745 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_11746 = cljs.core.first(cljs.core.vals(renders_11745));
...
if((cljs.core.count(renders_11745) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_11745))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_11746)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11746], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__11717 = o;
reagent.impl.component.goog$module$goog$object.set(G__11717,cljs.core.name(k),v);
